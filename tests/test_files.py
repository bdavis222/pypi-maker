...
class FilesTest(unittest.TestCase):
    def test_getNamesAndEmailsVerticallySpaced_spacesInfoProperly(self):
        ...
        output = files.getNamesAndEmailsVerticallySpaced(
    ...
    def test_getAuthorsNameLine(self):
        ...
        tripleNameLine = files.getAuthorsNameLine(
            ["John Doe", "Jane Toe", "Bob Smith"])
    ...
    def test_getAuthorNamesInline(self):
        ...
        threeNamesLine = files.getAuthorNamesInline(
            ["John Doe", "Jane Toe", "Bob Smith"])
